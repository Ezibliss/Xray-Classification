...
# Saving the model
torch.save(model.state_dict(), 'res50model.pth')
print('Model saved as res50model.pth')
#model_path = 'res50model.pth'
...
# Initialize Grad-CAM with the target layer (layer4 for ResNet)
